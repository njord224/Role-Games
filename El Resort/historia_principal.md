...
```mermaid
flowchart LR
  subgraph morning [Manana ActoI]
    A[Bienvenida y actividades resort]
    B[Primeras grietas en la ilusion]
  end
  subgraph afternoon [Tarde ActoII]
    C[Descubrimientos individuales]
    D[Alianza y plan de escape]
  end
  subgraph evening [Noche ActoIII]
    E[Intento de fuga coordinado]
    F[Resolucion con directores]
  end
